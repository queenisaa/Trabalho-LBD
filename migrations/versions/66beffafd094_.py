...
Revision ID: 66beffafd094
Revises: 
Create Date: 2025-06-17 23:24:30.544192
...
def upgrade():
    ...
    sa.Column('data_hora', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['id_conta'], ['conta.id_conta'], ),
    sa.ForeignKeyConstraint(['id_funcionario_responsavel'], ['funcionario.id_funcionario'], ),
