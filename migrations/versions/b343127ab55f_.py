...
Revision ID: b343127ab55f
Revises: 
Create Date: 2025-06-18 00:05:00.250278
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['id_conta_corrente'], ['conta.id_conta'], ),
    ...
    sa.ForeignKeyConstraint(['id_conta_investimento'], ['conta.id_conta'], ),
    ...
    sa.ForeignKeyConstraint(['id_conta_poupanca'], ['conta.id_conta'], ),
    sa.PrimaryKeyConstraint('id_conta_poupanca')
    )
    op.create_table('historico_conta',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_conta', sa.Integer(), nullable=False),
    sa.Column('id_funcionario_responsavel', sa.Integer(), nullable=False),
    sa.Column('acao', mysql.ENUM('Abertura', 'Encerramento'), nullable=False),
    sa.Column('motivo', sa.String(length=255), nullable=True),
    sa.Column('data_hora', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['id_conta'], ['conta.id_conta'], ),
    sa.ForeignKeyConstraint(['id_funcionario_responsavel'], ['funcionario.id_usuario'], ),
